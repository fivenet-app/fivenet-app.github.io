import{n as e}from"./CHMCcOXJ.js";import{t}from"./_NGkGgJp.js";import{C as n,E as r,J as i,Q as a,Y as o,b as s,l as c,m as l,o as u,x as d}from"./DXfdJXNF.js";import{t as f}from"./B2J2w5EN.js";import"./C4x2TL_0.js";import{t as p}from"./jamLxCoV.js";import{t as m}from"./KkLQ9yeG.js";import{t as h}from"./CY3qFTG3.js";import{M as g}from"./CCZsXycO.js";import"./DgWNcPV4.js";import{h as _,i as v}from"./BC89E7wm.js";import{p as y}from"./CT_t_6ry.js";var b=l.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:e(()=>structuredClone(w),`getConfig`),clear:e(()=>{S=new Map,C=x.showData,u()},`clear`),setDiagramTitle:a,getDiagramTitle:r,setAccTitle:o,getAccTitle:d,setAccDescription:i,getAccDescription:s,addSection:e(({label:e,value:n})=>{if(n<0)throw Error(`"${e}" has invalid value: ${n}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,n),t.debug(`added new section: ${e}, with value: ${n}`))},`addSection`),getSections:e(()=>S,`getSections`),setShowData:e(e=>{C=e},`setShowData`),getShowData:e(()=>C,`getShowData`)},E=e((e,t)=>{h(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:e(async e=>{let n=await g(`pie`,e);t.debug(n),E(n,T)},`parse`)},O=e(e=>`
  .pieCircle{
