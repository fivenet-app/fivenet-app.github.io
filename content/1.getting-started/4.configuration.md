...
::field{name="grpc"}
  ::collapsible
    :field{name="listen" type="string" default=":9090"}
  ::
::
...
::field{name="storage"}
  ::collapsible
    ::field{name="type" type="'filesystem' | 's3'" default="filesystem"}
...
::field{name="imageProxy"}
  ::collapsible
    ...
    :field{name="url" type="string" default="/api/image_proxy/"}

    :field{name="cachePrefix" type="string" default="images/"}

    ::field{name="options"}
      ::collapsible
        ::field{name="allowHosts" type="string[]" default="[]"}
        List of allowed hosts for caching images from external sources.
        ::

        ::field{name="denyHosts" type="string[]" default="[]"}
...
::field{name="cache"}
  ::collapsible
    :field{name="refreshTime" type="string" default="2m"}
  ::
::

::field{name="audit"}
  ::collapsible
    :field{name="retentionDays" type="number" default="90"}
  ::
::

::field{name="oauth2"}
  ::collapsible
    ::field{name="providers" default="[]"}
      ::collapsible
...
::field{name="auth"}
  ::collapsible
    ::field{name="superuserGroups" type="string[]" default="[]"}
    List of groups that will have superuser access in FiveNet.
    ::

    ::field{name="superuserUsers" type="string[]" default="[]"}
...
::fields{name="dispatchCenter"}
  ::collapsible
    ::field{name="convertJobs" type="string[]" default="[]"}
