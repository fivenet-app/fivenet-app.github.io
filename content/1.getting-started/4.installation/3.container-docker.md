...
Checkout the [`docker-compose.yml`](https://github.com/fivenet-app/fivenet/blob/main/docker-compose.yaml) as a starting point for you.

::callout
To build the FiveNet container image yourself, you need to have the [development requirements setup.](/getting-started/requirements#development)
::
