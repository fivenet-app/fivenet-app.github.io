...
::callout{color="success" variant="outline" icon="i-mdi-play-circle-outline"}
Schauen Sie sich unbedingt die Demo-Instanz an, um die Funktionen in Aktion zu sehen. Sie finden [die Demo-Instanz hier](./demo).
::
...
- Erstellt mit [Vue.js 3](https://vuejs.org/), [Nuxt 4](https://nuxt.com/), [Nuxt UI](https://ui.nuxt.com/docs/getting-started) und [TailwindCSS](https://tailwindcss.com/).
...
![FiveNet Übersicht](/images/screenshots/overview.webp)
