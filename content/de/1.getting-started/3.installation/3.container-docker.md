...
Sie können nun mit dem nächsten Schritt fortfahren, um die Datei `docker-compose.yaml` für Ihren Fall vorzubereiten.
...
Starten Sie die Server-, Worker- und Discord-Container mit `docker compose`:
