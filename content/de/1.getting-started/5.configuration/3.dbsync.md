...
Schließen Sie zuerst [FiveNet konfigurieren](configure) ab, damit Datenbank, NATS-Verbindung, öffentliche URL und Sync-API-Token eingerichtet sind.
...
6. Stellen Sie sicher, dass die Sync-API in Ihrer zentralen FiveNet-`config.yaml` aktiviert ist und mindestens ein Sync-Token konfiguriert wurde. Siehe [Konfigurationsdatei-Referenz](../reference/config-reference#erforderliche-konfigurationsoptionen).
