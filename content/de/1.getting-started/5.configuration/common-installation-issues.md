...
Wenn der Server `utf8mb4_unicode_ci` verwendet, Ihre DSN jedoch `utf8mb4_unicode_ci` angibt, kann diese Diskrepanz Probleme verursachen. Aktualisieren Sie die DSN, um den richtigen Kollationsparameter zu verwenden.
