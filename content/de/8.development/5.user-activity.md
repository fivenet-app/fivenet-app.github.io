...
::callout{color="warning" icon="i-mdi-alert" to="development/grpc-api.md#useractivity"}
Diese Seite enthält Informationen über eine **veraltete API**. Bitte werfen Sie einen Blick auf die **GRPC API Dokumentation - UserActivity Typ** für die neue Methode/Struktur zum Senden von Benutzeraktivitätsereignissen.
::
