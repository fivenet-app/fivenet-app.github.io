...
- Built using [Vue.js 3](https://vuejs.org/), [Nuxt 4](https://nuxt.com/), [Nuxt UI](https://ui.nuxt.com/docs/getting-started) and [TailwindCSS](https://tailwindcss.com/).
...
![FiveNet Overview](/images/screenshots/overview.webp)
