...
- [Tracing](/getting-started/reference/advanced#tracing): OpenTelemetry-based tracing is available for the FiveNet server and worker components. It is useful for troubleshooting and performance monitoring.
