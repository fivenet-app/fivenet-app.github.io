...
For additional details, tips and info on the plugin setup, refer to the [plugin setup documentation](../gameserver/fivem-plugin/installation) to ensure proper integration and configuration.
