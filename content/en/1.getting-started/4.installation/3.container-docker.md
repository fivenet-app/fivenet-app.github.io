...
Before you begin, review the [requirements](../2.requirements.md) and make sure your database, NATS server, storage, domain, and reverse proxy are ready.
...
- The image tags you want to deploy (e.g., a [release](https://github.com/fivenet-app/fivenet/releases) or a [development version](https://github.com/fivenet-app/fivenet/pkgs/container/fivenet)).
...
::callout
To build the FiveNet container image yourself, first review the [development requirements](../../../8.development/1.index.md).
::
...
Follow the [Configure FiveNet guide](/getting-started/configuration/configure) to create a working `config.yaml`, then use the [Config File Reference](/getting-started/reference/config-reference) for individual options.
...
Check the [DBSync page](/getting-started/configuration/dbsync) to create a working `dbsync.yaml` for FiveNet DBSync.
...
If you face issues during the containerized installation, such as database collation mismatches, check the [Database and Installation Troubleshooting](/getting-started/troubleshooting/installation-issues) page for solutions.
