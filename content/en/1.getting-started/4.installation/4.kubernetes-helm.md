...
Edit the `values.yaml` file to suit your deployment needs. Follow the [Configure FiveNet guide](../configuration/configure) for the required settings in `.fivenet.config`, then use the [Config File Reference](../reference/config-reference) for individual options.
...
For common issues during Kubernetes or Helm installation, such as database-related errors, refer to the [Database and Installation Troubleshooting](../troubleshooting/installation-issues) page.
