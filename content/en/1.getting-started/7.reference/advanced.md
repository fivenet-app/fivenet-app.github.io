...
For the most important option names and config paths, see the [Config File Reference](./config-reference).
...
See the [Config File Reference](./config-reference#http) for the `http.trustedProxies` setting.
...
See the [Config File Reference](./config-reference#storage) for the `storage.type` setting and related storage options.
...
See the [Config File Reference](./config-reference#oauth2) for the `oauth2.providers` setting.
