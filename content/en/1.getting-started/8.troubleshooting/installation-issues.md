...
This issue occurs when the collation of your database, tables, or columns is inconsistent. To resolve this, ensure that the collation is consistent across all tables. Refer to the [Database Setup](/getting-started/reference/database-setup) documentation for detailed guidance on checking and updating collations.
